...
```{r}
plot(sleep$Primate ~ factor(Primate), data = sleep)
plot(sleep$Primate, sleep$TotalSleep, 
     xlab = "Primate", ylab = "Total Sleep",
     main = "Total Sleep Time: Primates vs Other Species")
```
